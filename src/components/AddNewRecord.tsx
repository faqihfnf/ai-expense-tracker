        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 p-3 sm:p-4 bg-gradient-to-r from-green-50/50 to-emerald-50/50 dark:from-green-900/10 dark:to-emerald-900/10 rounded-xl border border-green-100/50 dark:border-green-800/50">
          ...
          <div className="space-y-1.5">
            <label htmlFor="category" className="flex items-center gap-2 text-xs font-semibold text-gray-700 dark:text-gray-300 tracking-wide">
              <span className="w-1.5 h-1.5 bg-green-500 rounded-full"></span>
              Category
              <span className="text-xs text-gray-400 dark:text-gray-500 ml-2 font-normal hidden sm:inline">Use the ✨ button above for AI suggestions</span>
            </label>
            <select
              id="category"
              name="category"
      ...
      {alertMessage && (
        <div
          className={`mt-4 p-3 rounded-xl border-l-4 backdrop-blur-sm ${
            alertType === "success" ? "bg-green-50/80 dark:bg-green-900/20 border-l-green-500 text-green-800 dark:text-green-200" : "bg-red-50/80 dark:bg-red-900/20 border-l-red-500 text-red-800 dark:text-red-200"
          }`}
        >
          <div className="flex items-center gap-2">
            <div className={`w-6 h-6 rounded-full flex items-center justify-center ${alertType === "success" ? "bg-green-100 dark:bg-green-800" : "bg-red-100 dark:bg-red-800"}`}>
