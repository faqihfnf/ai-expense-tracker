...
export default function ThemeToggle() {
  ...
  return (
    <button
      ...
      {/* Toggle Button */}
      <div
        className={`absolute top-0.5 w-7 h-7 bg-white dark:bg-gray-800 rounded-full shadow-md flex items-center justify-center transition-all duration-300 transform ${
          theme === "light"
            ? "left-0.5 bg-gradient-to-br from-yellow-50 to-orange-50 dark:from-gray-800 dark:to-gray-700"
            : "left-8 bg-gradient-to-br from-emerald-50 to-green-50 dark:from-gray-700 dark:to-gray-800"
        }`}>
        <span
